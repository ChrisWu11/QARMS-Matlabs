...
## 
## Makefile     : Chart.mk
## Generated on : Thu Mar 05 21:00:16 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Chart.exe
...
PRODUCT_NAME              = Chart
MAKEFILE                  = Chart.mk
MATLAB_ROOT               = D:/R2024b
MATLAB_BIN                = D:/R2024b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = D:/Applied-Robotics
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = Chart_comp.rsp
CMD_FILE                  = Chart.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Chart.exe
...
DEFINES_STANDARD = -DMODEL=Chart -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/Chart_grt_rtw/Chart.c $(START_DIR)/Chart_grt_rtw/Chart_data.c $(START_DIR)/Chart_grt_rtw/rt_nonfinite.c
...
OBJS = rt_logging.obj Chart.obj Chart_data.obj rt_nonfinite.obj
...
%.obj : $(START_DIR)/Chart_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Chart_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Chart_grt_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Chart_grt_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Chart_grt_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Chart.obj : $(START_DIR)/Chart_grt_rtw/Chart.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Chart_data.obj : $(START_DIR)/Chart_grt_rtw/Chart_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/Chart_grt_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
