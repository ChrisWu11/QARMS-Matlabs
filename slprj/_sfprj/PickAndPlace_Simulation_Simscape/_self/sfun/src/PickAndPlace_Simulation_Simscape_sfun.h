#ifndef __PickAndPlace_Simulation_Simscape_sfun_h__
#define __PickAndPlace_Simulation_Simscape_sfun_h__
...
extern mxArray* load_PickAndPlace_Simulation_Simscape_optimization_info
  (boolean_T isRtwGen, boolean_T isModelRef, boolean_T isExternal);
extern void unload_PickAndPlace_Simulation_Simscape_optimization_info(void);
