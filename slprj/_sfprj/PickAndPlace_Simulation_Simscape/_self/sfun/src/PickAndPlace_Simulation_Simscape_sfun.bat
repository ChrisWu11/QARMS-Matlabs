...
set COMPILER=C:\ProgramData\MATLAB\SupportPackages\R2024b\3P.instrset\mingw_w64.instrset\bin\gcc
                ...
                set LINKFLAGS=-m64 -Wl,--no-undefined -shared -static -L"D:\R2024b\extern\lib\win64\mingw64" -llibmx -llibmex -llibmat -lm -llibmwlapack -llibmwblas -Wl,"D:\R2024b/extern/lib/win64/mingw64/mexFunction.def"
                set LINKDEBUGFLAGS=-g
                set NAME_OUTPUT=-o "%OUTDIR%%MEX_NAME%%MEX_EXT%"
set PATH=C:\ProgramData\MATLAB\SupportPackages\R2024b\3P.instrset\mingw_w64.instrset\bin;D:\R2024b\extern\include\win64;D:\R2024b\extern\include;D:\R2024b\simulink\include;D:\R2024b\lib\win64;%MATLAB_BIN%;%PATH%
...
set LIBPATH=D:\R2024b\extern\lib\win64;%LIBPATH%

gmake SHELL="cmd" -f PickAndPlace_Simulation_Simscape_sfun.gmk
